<!doctype html>
<?php $titulo = "Governance | Commitments"; ?>
<html lang="en">
<head>
    ...
    <div class="container" style="height: 25vh;">
        <div class="row">
            ...
            <div class="col-4 p-3 text-center">
                <img  class="img-responsive imgBoxSocial bg-img-bottom" src="../assets/image/ods_en/ods-17-box.svg"  alt="">
            </div>
...
<section class="bg-ligth">
    <div class="container-fuid d-flex justify-content-center align-items-center bg-double-wabe">
        <div class="contPano imagenPano3 d-block d-sm-block d-md-none">
        </div>
