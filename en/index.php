<!doctype html>
<?php $titulo = "Welcome to Grupo Esfuerzo"; ?>
<html lang="es">
    <head>
                    ...
                    <div class="col welcome-title">
                        <div class="row">
                            <div class="text-white text-light">
                                ...
                                <h2 class="mb-4">We produce Bananas from Costa Rica <br>
                                using sustainable practices  <br> <span class="text-primary">FOOD THAT NOURISHES THE PLANET</span></h2>
                            </div>
                        </div>
                        <picture>
                        ...
                        <div class="py-3">
                            <picture>
                                <img class="certificates" src="../assets/image/cert-en/certificado-en-proceso-blanco.svg" height="35" class="" alt="carbono natural">
        ...
        <section class="bg-greyligth py-5">
            ...
            <div class="container-sm">
                <div class="row text-center text-grey py-5 contador-cont">
                    <picture>
                        <img class="certificates" src="../assets/image/cert-en/certificado-en-proceso.svg" height="60" class="" alt="carbono natural">
            ...
            <div class="container-fluid" style="background: url(../assets/image/min/globe-min.png) no-repeat; background-size:cover;">
                <div class="container-sm bg-mg">
                    <div class="row"  id="bellLogo" onmouseover="hvr(this, 'in')" onmouseleave="hvr(this, 'out')">
                        ...
                        <img class="world" class=bell style="display:none" col="b" src="../assets/image/mapHiverEnglisg.svg" alt="">
