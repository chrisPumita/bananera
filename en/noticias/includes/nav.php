<nav id="menu" class="navbar var-contacto fixed-top navbar-expand-lg navbar-inverse navbar-light">
    <div class="container-sm">
        ...
        <div class="collapse navbar-collapse border-menu" id="menuvar">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 justify-content-end menu">
                ...
                <li class="nav-item">
                    <a class="nav-link text-secondary" aria-current="page" id="m2"  href="../../producto.php"><span class="text-grey">PRODUCTS</span></a>                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link text-secondary" aria-current="page" id="m4" href="../../noticias.php"><span class="text-grey">NEWS</span></a>
                </li>
                <li class="nav-item">
