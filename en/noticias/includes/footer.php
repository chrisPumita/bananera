        ...
        <div class="row ">
            ...
            <div class="col-xl-4 col-md-4 col-sm-4 col-12">
                ...
                <p class="text-grey notice-footer">
                    <a class="linkfooter" href="../jul-2021">GRUPO ESFUERZO LAUNCHES NEW WEBSITE</a>
                <hr class="hr-div-notice">
                Jul 2021
                </p>
                <p class="text-grey notice-footer">
                    <a class="linkfooter" href="../jun-2021">GRUPO ESFUERZO PARTICIPATES IN THE CONSTRUCTION OF A DAM</a>
                <hr class="hr-div-notice">
                Jun 2021
                </p>
            </div>
