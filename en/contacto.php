<!doctype html>
<?php $titulo = "Contact Us | Grupo Esfuerzo"; ?>
<html lang="en">
<head>
        ...
        <div class="container-sm">
            ...
            <div class="collapse navbar-collapse border-menu" id="menuvar">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0 justify-content-end menu">
                    <li class="nav-item">
                        <a class="nav-link text-secondary text-uppercase" aria-current="page" id="m1" href="./nosotros.php"><span class="text-grey">About Us</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-secondary text-uppercase" aria-current="page" id="m2"  href="./producto.php"><span class="text-grey">Products </span></a>
                    </li>
