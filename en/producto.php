...
<section class="bg-greyligth top-header">
    ...
    <div class="wabe-button-producto">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ededed" fill-opacity="1" d="M0,160L80,144C160,128,320,96,480,122.7C640,149,800,235,960,240C1120,245,1280,171,1360,133.3L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
    </div>
    <div class="container d-flex justify-content-center align-items-center slider-border">
        <div class="row container-headers">
            <div class="col text-parrafo">
                <div class="row">
                    <div class="text-secondary">
            ...
            <div class="col">
                <div id="carouselExampleIndicators" class="carousel slide carricel-size" data-bs-ride="carousel">
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex cita-world">
                    ...
                    <div class="col-10 text-light text-mje">
                        <div class="row">
                            <h4>Finca Esfuerzo</h4>
                        </div>
                        <div class="row py-3">
                            <picture>
                                <img class="certificates" src="../assets/image/cert-en/certificado-en-proceso-blanco.svgg" height="35" alt="carbono natural">
