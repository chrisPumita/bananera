        ...
        <div class="row ">
            <div class="col-xl-4 col-md-4 col-sm-4 col-12 my-auto mx-auto a">
                ...
                <ul class="list-unstyled text-grey">
                    <li><a class="linkfooter" href="./contacto.php#map">Finca Agro (Farm)</a></li>
                    <li><a class="linkfooter" href="./contacto.php#map">Finca Esfuerzo (Farm)</a></li>
                    <li><a class="linkfooter" href="./contacto.php#map">Finca Vesta (Farm)</a></li>
                    <li><a class="linkfooter" href="./contacto.php#map">Finca Bristol (Farm)</a></li>
                </ul>
            ...
            <div class="col-xl-4 col-md-4 col-sm-4 col-12">
                <h6 class="mb-3 mb-lg-4 text-grey "><b>Latest News</b></h6>
                <p class="text-grey notice-footer">
                    <a class="linkfooter" href="./noticias/jul-2021">GRUPO ESFUERZO LAUNCHES NEW WEBSITE </a>
                <hr class="hr-div-notice">
                Jul 2021
                </p>
                <p class="text-grey notice-footer">
                    <a class="linkfooter" href="./noticias/jun-2021">GRUPO ESFUERZO PARTICIPATES IN THE CONSTRUCTION OF A DAM </a>
                <hr class="hr-div-notice">
                Jun 2021
                </p>
            </div>
            <div class="col-xl-4 col-md-4 col-sm-4 col-12">
                <h6 class="mb-3 mb-lg-4 text-grey "><b>Contact us</b></h6>
                <ul class="list-unstyled text-grey">
...
<!-- Modal -->
<div class="modal fade" id="modalPrivate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
