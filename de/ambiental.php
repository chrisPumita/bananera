<!doctype html>
<?php $titulo = "Umwelt | Die Verpflichtung"; ?>
<html lang="en">
<head>
    ...
    <div class="container" style="height: 25vh;">
        <div class="row">
            <div class="col-4 p-3 text-end">
                <img class="img-responsive imgBoxSocial" src="../assets/image/osd-de/ods-7-box.svg" alt="">
            </div>
            <div class="col-4 p-3 text-center">
                <img  class="img-responsive imgBoxSocial" src="../assets/image/osd-de/ods-12-box.svg"  alt="">
            </div>
            <div class="col-4 p-3 text-start">
                <img class="img-responsive imgBoxSocial" src="../assets/image/osd-de/ods-15-box.svg" alt="">
            </div>
        </div>
    </div>
    </div>
...
<section style="background: url(../assets/image/min/bg-footer-ambiente1-min.png)center fixed no-repeat ">
    ...
    <div class="container-fluid img-producto-bk ">
    ...
    <div class="">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFFFFF" fill-opacity="1" d="M0,160L80,144C160,128,320,96,480,122.7C640,149,800,235,960,240C1120,245,1280,171,1360,133.3L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
    </div>
</section>
